...
Extends the classify.py program to iterate over a "classify / example" directory,
instead of asking the model to classify one image at a time.
Assumes that the classifier is already trained and serialized.
