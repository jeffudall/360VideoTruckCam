...
Images are specified from the command line (this can be modified so we load images using webcams or a directory to images).
From source: https://github.com/pavanpn/Image-Stitching
"""
